...
function MarkerContent({ children, className }: MarkerContentProps) {
  ...
  return createPortal(
    <div className={cn("map-marker-wrapper", className)}>
...
function DefaultMarkerIcon() {
  return (
    <div className="map-default-marker" />
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      type="button"
      className={cn("map-control-button", disabled && "disabled")}
      disabled={disabled}
    >
      {children}
    </button>
    ...
    >
      {showZoom && (
        <ControlGroup>
          <ControlButton onClick={handleZoomIn} label="Zoom in">
            <Plus className="map-icon" />
          </ControlButton>
          <ControlButton onClick={handleZoomOut} label="Zoom out">
            <Minus className="map-icon" />
          </ControlButton>
        </ControlGroup>
      )}
      {showCompass && (
      ...
      {showLocate && (
        <ControlGroup>
          ...
          >
            {waitingForLocation ? (
              <Loader2 className="map-icon spinning" />
            ) : (
              <Locate className="map-icon" />
            )}
          </ControlButton>
        </ControlGroup>
      )}
